...
const page = () => {
  ...
  const handelSubmit = (e) => {
    ...
    axios
      .post("/api/adminapis/addTicket", JSON.stringify(body))
      .then((res) => {
  ...
  useEffect(() => {
    if (
      ...
      setBody({
        oneWay: { ...oneWay, TicketType: "oneWay" },
      ...
      setBody({
        oneWay: { ...oneWay, TicketType: "oneWay" },
        returnTicket: { ...returnTicket, TicketType: "returnTicket" },
        price: price,
      });
    }
  }, [oneWay, returnTicket, price]);
  if (loading) {
    return <SpinnerPage />;
  } else {
    return (
        ...
        <main className="grid grid-cols-[90px,1fr]">
          ...
          <section className="grid grid-rows-[60px,1fr]  h-screen">
            ...
            <section className="h-screen">
              <HeadTitle title="Adding Tickets" />
              <section className=" h-[90%] flex flex-col justify-center items-center">
                <div className="w-[40%] min-w-[500px] switch flex justify-between items-center p-[20px]">
                  <button
                    className={`  p-2 rounded-lg px-4 w-[100px] h-[45px] text-sm ${
                      returnFlight
                  ...
                  <button
                    className={`  p-2  rounded-lg px-4 w-[150px] h-[45px] text-sm flex gap-2 justify-center items-center  ${
                      !returnFlight
                        ? "border-secondary border-2 text-secondary"
                        : "bg-secondary text-white"
                    }`}
                  ...
                  >
                    Set Return <FaArrowRight />
                  </button>
                </div>
                <form
                  className="relative w-[40%] min-w-[500px] h-[90%] overflow-hidden"
                  onSubmit={handelSubmit}
                >
                  {/* one way */}
                  <motion.div
                    initial={returnFlight ? { x: 0 } : { x: -2000 }}
                    animate={returnFlight ? { x: -2000 } : { x: 0 }}
                    transition={{ duration: 0.5 }}
                    className={`absolute w-full h-[90%] bg-white grid p-[20px] text-[17px] `}
                    layout
                  >
                    One Way
                  ...
                  <button
                    type="submit "
                    className=" absolute bottom-0 w-full p-4 bg-primary text-white"
                  >
                    Add
                  </button>
                </form>
